...
This is the course project for Data Science Course 4 - Exploratory Data Analysis. The files submitted include 6 R files and 6 png files:

1. Plot1.R  - plots Plot1.png
2. Plot2.R  - plots Plot2.png
3. Plot3.R  - plots Plot3.png
4. Plot4.R  - plots Plot4.png
5. Plot5.R  - plots Plot5.png
6. Plot6.R  - plots Plot6.png
